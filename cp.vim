...
set shortmess=aoO
badd +1 cp_quickref
badd +1 xsl\podcast.xsl
badd +7 xsl\wp.xsl
badd +3 xml\missal.xml
badd +35 java\src\com\catholicpatrimony\GDocTransformerGr.groovy
badd +1 java\src\example\Hello.java
badd +151 java\ivy-build.xml
badd +0 java\ivy\ivy.xml
badd +0 java\build.xml
args cp_quickref
edit cp_quickref
...
1
normal! 0
lcd C:\google_code\cp
wincmd w
argglobal
edit C:\google_code\cp\xml\missal.xml
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe '1resize ' . ((&lines * 23 + 24) / 48)
exe '2resize ' . ((&lines * 22 + 24) / 48)
tabedit C:\google_code\cp\java\src\com\catholicpatrimony\GDocTransformerGr.groovy
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
20
normal zo
let s:l = 35 - ((27 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
normal! 07l
lcd C:\google_code\cp
tabedit C:\google_code\cp\java\build.xml
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit C:\google_code\cp\java\ivy-build.xml
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
124
normal zo
let s:l = 79 - ((18 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
...
exe 'vert 1resize ' . ((&columns * 91 + 90) / 181)
exe 'vert 2resize ' . ((&columns * 89 + 90) / 181)
tabedit C:\google_code\cp\java\ivy\ivy.xml
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
